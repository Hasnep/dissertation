...
\DeclareNameAlias{sortname}{family-given} % bibliography show names as surname, then firstname
\renewbibmacro{in:}{} % remove the "in: " beforea journal's name
