...
As deep neural networks were designed to mimic a biological brain, a \reword{phenomenon} that is still not well understood, they are a \qt{black box} \reword{whose} reasoning is impossible to understand.
