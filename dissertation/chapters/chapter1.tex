...
These tasks are so complex that designing an algorithm by hand to \reword{tackle} them would be impossible, so instead, we design a process that \reword{teaches} the machine to find patterns and \reword{respond intelligently}~\autocite[1]{murphy2012}.
