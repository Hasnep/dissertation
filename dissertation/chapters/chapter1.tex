...
One of these \ac{ML} algorithms is the \ac{ANN}, which takes inspiration from the neural structure of the biological brain.
\acp{ANN} consist of units called \qt{neurons}, which individually perform a simple nonlinear operation, but when interconnected can understand more complex structures~\autocite[436]{lecun2015}.
