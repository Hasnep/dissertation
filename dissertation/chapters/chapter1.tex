...
Since the turn of the millennium, \acl{ML}, and particularly \acl{DL} have been able to solve many problems that were once thought impossible for a computer and surpass traditional algorithms in many contexts.
...
One of these \acl{ML} algorithms is the \acl{ANN}, which takes inspiration from the neural structure of the biological brain.
...
Due to the abstracted nature of \iacl{ML} algorithm's calculations, it can be difficult to provide a human understandable explanation for its reasoning, and often it is impossible.
...
\acl{ML} systems which aid in probation and parole decisions in the U.S.\ are now being trialled for sentencing, but have come under a lot of criticism for being racially biased~\autocite{christin2015}.
